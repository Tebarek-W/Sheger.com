export const en = {
  ...
  auth: {
    ...
    resetEmailSentMessage:
      "If an account exists for that email, we sent a password reset link. Open it on this device to continue.",
    ...
    fillNewPassword: "Enter and confirm your new password.",
