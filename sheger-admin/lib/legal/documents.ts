...
export const LEGAL_DOCS: Record<LegalDocId, LegalDocMeta> = {
  terms: {
    ...
    description: "Terms governing use of the ABORA mobile app and marketplace.",
    sections: [
      {
      ...
      {
        heading: "2. Accounts",
        body: "You must provide accurate information when creating an account. You are responsible for keeping your login credentials secure and for activity under your account. You must be old enough under Ethiopian law to enter a binding agreement. You can delete your account at any time from Profile (or the owner dashboard).",
      },
      {
        heading: "3. Bookings",
  ...
  privacy: {
    ...
    description:
      "How ABORA collects, uses, and shares personal information in the mobile app and related services.",
    sections: [
      {
        heading: "1. Information we collect",
        body: "We may collect account details (name, email, phone), booking history, device and app usage data, approximate or precise location (if you allow it for Nearby), photos you upload (such as a business profile picture), license documents for business verification, and payment-related references from Chapa (not full payment credentials).",
      },
      {
      ...
      },
      {
        ...
        body: "You may update profile information in the app, delete your account from Profile (or the owner dashboard), and manage notification and location permissions on your device. Deleting your account removes your login and associated personal profile data, subject to records we must keep for legal or payment reasons.",
      },
      {
        heading: "7. Contact",
  ...
  business: {
    ...
    description: "Terms for businesses listing and accepting bookings on ABORA.",
    sections: [
      {
  ...
  cancellation: {
    ...
    description: "How cancellations and refunds work for ABORA bookings.",
    sections: [
      {
